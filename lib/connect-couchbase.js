...
const debug = require('debug')('connect:couchbase');
const COUCHBASE_CONNECTION_PREFIX = 'couchbase://';
...
module.exports = function(session){
    ...
    function CouchbaseStore(options) {
        ...
        if ( typeof(connectOptions.db) != 'undefined' ) {
            ...
            if (host.indexOf(COUCHBASE_CONNECTION_PREFIX) !== 0) {
                host = COUCHBASE_CONNECTION_PREFIX + host;
            }
            console.log('host: ' + host);
            console.log('username: ', connectOptions.username);
            console.log('password: ', connectOptions.password);
